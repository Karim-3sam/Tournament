...
?>      
        ...
        <form method="POST" action="join_tournament.php" class="card p-4 shadow-lg mx-auto " >
            <h1 class="mb-4">Join The Tournament</h1>
            <div class="mb-3">
                <label for="username" class="form-label">Your name</label>
                <input type="text" name="username" class="form-control form-control-lg border-primary" id="username" required>
            </div>
            <input type="hidden" id="tournament_id" name="tournament_id"value="<?php echo htmlspecialchars($_GET['id']); ?>">
